...
export const ProductCard = (props) => {
  const { title, imgAddress, price, id, about } = props.productInfo;
    ...
    <div className="col-3">
      <div className="card mt-5">
        ...
        <div className="card-footer border-0 bg-white d-flex justify-content-between">
          <button className="btn btn-lg text-white" style={btn} onClick={handleSelected}>
            {selected ? `Выбран ${selected}` : "Выбрать"}
          </button>
          <h5 className="m-3" style={text}>
            от {price} ₽
          </h5>
        </div>
      </div>
